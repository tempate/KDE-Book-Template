...
\medskip
Edición\par
\quad\textbf{\editorNameA}\par
\quad\textbf{\editorNameB}\par
Maquetación\par
\quad\textbf{\typesetterName}\par
Ilustraciones de la portada\par
\quad\textbf{\coverDesignerName}\par
Maquetación de la portada\par
\quad\textbf{\designerNameA}\par
\quad\textbf{\designerNameB}\par

\medskip
Primera edición: \today\par
ISBN \softcoverISBN\par
\vspace*{\fill}
